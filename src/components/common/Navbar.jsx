...
<nav className="relative bg-gray-800">
  <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    <div className="relative flex h-16 items-center justify-between">
      ...
      <Link to="/"  className="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white">Dashboard</Link>
      <Link to="/products"  className="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white">Products</Link>
      <Link to="/cart"  className="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white">Cart</Link>          </div>
        </div>
      </div>
  ...
  <el-disclosure id="mobile-menu" hidden className="block sm:hidden">
    <div className="space-y-1 px-2 pt-2 pb-3">
      ...
      <Link to="/"  className="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white">Dashboard</Link>
      <Link to="/products"  className="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white">Products</Link>
      <Link to="/cart"  className="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white">Cart</Link>
    </div>
  </el-disclosure>
</nav>
